...
$select = "SELECT * FROM blogs WHERE status=0 order by id desc";
          ...
          <div
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">
                <a href="javascript:void(0);">All Inactive Blogs</a>
              </li>
            </ol>
          </div>
        </div>
              ...
              <div id="list-view" class="tab-pane fade active show col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">All Inactive Blogst</h4>
                            ...
                            <tr>
                              <td>
                                <img
                                  ...
                                  width="35"
                                  src="../uploads/blogs/<?php echo $row['image']?>"
                                  alt="" />
                              </td>
                              ...
                              <td>
                                ...
                                <a
                                  href="../controllers/active-blog.php?id=<?php echo $row['id']?>"
                                  class="btn sharp btn-info">Active</a>
                              </td>
                            </tr>
