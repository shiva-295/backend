          ...
          <div
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">
                <a href="javascript:void(0);">All Active Blogs</a>
              </li>
            </ol>
          </div>
        </div>
              ...
              <div id="list-view" class="tab-pane fade active show col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">All Active Blogst</h4>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a
                                  href="../controllers/inactive-blog.php?id=<?php echo $row['id']?>"
                                  class="btn sharp btn-danger">Inactive</a>
                              </td>
                            </tr>
